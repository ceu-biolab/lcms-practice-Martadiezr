...
public class Annotation {
    ...
    /**
     * Automatically detects the most probable adduct by comparing the mass differences
     * between grouped peaks (groupedSignals) with known characteristic adduct mass shifts.
     *
     * @param ppmTolerance parts-per-million tolerance to consider a valid match
     */
    /**
